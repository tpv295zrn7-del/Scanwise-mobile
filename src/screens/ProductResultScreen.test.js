...
describe('ProductResultScreen', () => {
  test('renders product details', () => {
    const screen = ProductResultScreen({ scanResult: mockScanResponses.verified });
  ...
  test('renders confidence badge from scan result', () => {
    const screen = ProductResultScreen({ scanResult: mockScanResponses.estimated });
  ...
  test('renders Save, Compare, and Correct buttons', () => {
    const screen = ProductResultScreen({ scanResult: mockScanResponses.incomplete });
